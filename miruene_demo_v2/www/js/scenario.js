...
var scenario_data = {
    "SCENARIO_HEATPROTECT": {
        "NAME": "熱中症予防",
        "PARAM": "1:HIDE:#scene_top_button,2:IR_COMMAND:THERMOMETER_UP,2:IR_COMMAND:THERMOMETER_UP1,3:WAIT:4,5:IR_COMMAND:CURTAIN_CLOSE,6:WAIT:3,7:IR_COMMAND:AIRCON_ON, 8:SHOW:#scene_top_button"
    },
    ...
    "SCENARIO_ALLT_RESET": {
        "NAME": "シナリオ全初期化",
        "PARAM": "0:IR_COMMAND:TV_ACONOFF,1:IR_COMMAND:LAMP_ON, 2:IR_COMMAND:THERMOMETER_DOWN, 3:IR_COMMAND:AIRCON_OFF, 4:IR_COMMAND:PURIFER_OFF, 5:IR_COMMAND:TV_ACONOFF, 6:IR_COMMAND:LIGHT_OFF,7:IR_COMMAND:AUDIO_ACONOFF,7:IR_COMMAND:AUDIO_ACONOFF,8:IR_COMMAND::AIRCON_ACONOFF"
    },
};
